...
export const GeneratedK = () => {
    ...
    const {genratedAddressK, bridgeFeeAmount, setGeneratedAddressK,bridgeAmount, tokenName, isGeneratedK, setIsGeneratedK } = GlobalContext()
        ...
        <div className="lg:h-[420px] h-auto w-[80%] lg:w-[50%] py-3 px-3 mb-20 mt-16 lg:mt-[200px] drop-shadow-glow2 bg-black/65 rounded-3xl ml-auto mr-auto">
            <div className="w-[99%] rounded-2xl mt-3 bg-black/35 h-[98%] ml-auto mr-auto">
                <div className=" ml-auto mr-4 flex py-0.5 px-0.5 w-[98%] h-8">
                    ...
                    <p onClick={() => setIsGeneratedK(false)} className="w-[100px] cursor-pointer mt-5 h-8 bg-black/75 text-center ml-auto mr-1 py-1 rounded-full">close</p>
                </div>
                {
                    genratedAddressK === '' ?
  ...
  />
                    ...
                    <div className="w-[80%] mt-[65px] text-center flex lg:text-2xl  bg-black/75 py-4 px-2 rounded-lg  h-[60px] ml-auto mr-auto">
                      <p  className="ml-auto mr-2">{formatEthAddress(genratedAddressK)}</p>
                      <IoIosCopy className="ml-4 text-white/70 mr-auto" onClick={() => handleCopy(genratedAddressK)} />
                   </div>
                }
                <div>
                    {
