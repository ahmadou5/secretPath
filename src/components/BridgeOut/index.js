...
export const BridgeOut = () => {
    ...
    <div>
        ...
        { keplrAddress !== '' && <div className="w-[207px] flex text-xl ml-auto mr-auto py-1.5 px-6 text-center bg-blue-600/50 h-10 drop-shadow-glow  rounded-3xl">
            ...
            <div className="relative mt-[0px] flex bg-gradient-conic after:from-[#0141ff] after:via-[#0146ff] after:blur-2xl after:content-[''] before:dark:bg-gradient-to-br before:dark:from-transparent before:dark:to-blue-700 before:dark:opacity-10 after:dark:from-sky-900 after:dark:via-[#0141ff]"></div>
