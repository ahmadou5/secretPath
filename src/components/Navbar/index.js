            ...
            <div className="ml-0 mr-auto mt-auto mb-auto">
              <Link href={"/"}>
                <div className="text-xl font-semibold flex">
                 ...
                 <p className="text-white text-2xl font-bold ml-1">Secret<span className="text-white">Path</span></p>
                </div>
              </Link>
            </div>
          ...
          <div className="py-5 px-5  mt-auto mb-auto ml-auto mr-auto w-[98%] flex flex-row  h-[90%]">
            <div className="ml-0 mr-auto">
              <Link href={"/"}>
                <div className="text-sm flex">
                  {/**<img className="w-[52px] h-[52px]" src="./assets/body.png" />**/}
                  <p className="text-white text-3xl font-thin ml-1">Secret<span className="text-white font-extrabold">Path</span></p>
                </div>
              </Link>
            </div>
            <div className="mr-4 ml-auto px-2 py-2">
              <div className="flex  text-white flex-row">
                ...
                <Link target="_blank" href={`https://app.shadeprotocol.io/swap`} className="flex ml-2 mr-2 ">
                    <div className="ml-0 mr-0 text-white/80 flex cursor-pointer hover:font-light font-bold text-2xl">
                      <p>{'ShadeSwap'}</p>
                      <FaArrowUpRightFromSquare className="mt-2 text-xl"/>
                    </div>
                  </Link>
              </div>
            </div>
